...
brute_force_start_button.grid(row=22, column=0, columnspan=2, padx=10, pady=10)

brute_force_cracked_password_label.grid(row=23, column=0, columnspan=2, padx=10, pady=10)
brute_force_time_elapsed_label.grid(row=24, column=0, columnspan=2, padx=10, pady=10)
